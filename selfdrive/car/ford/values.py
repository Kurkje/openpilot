...
FW_VERSIONS = {
  ...
  CAR.FOCUS_MK4: {
    (Ecu.eps, 0x730, None): [
      ...
      b'JX6C-14D003-AK\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.abs, 0x760, None): [
      b'JX61-2D053-CJ\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
      b'JX61-2D053-KD\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.fwdRadar, 0x764, None): [
    ...
    (Ecu.engine, 0x7E0, None): [
      ...
      b'JX6A-14C204-BRM\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
  },
  CAR.MAVERICK_MK1: {
    (Ecu.eps, 0x730, None): [
